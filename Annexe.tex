\chapter*{Annexe : Code source de l'application}
\addcontentsline{toc}{chapter}{Annexe : Code source de l'application}

%===========================================
\section*{Annexe A : Module Réclamation (Back-end Spring Boot)}
%===========================================
...
%===========================================
\section*{Annexe B : Module Formulaire WebView (Front-end React JS)}
%===========================================

\subsection*{CentreReclamations.tsx}
\begin{lstlisting}[language=Java]
// src/pages/CentreReclamations.tsx
...
%===========================================
\section*{Annexe C : Module Dashboard Monitor (Front-end React JS)}
%===========================================

\subsection*{reclamation.mapper.ts}
\begin{lstlisting}[language=Java]
/**
 * Reclamation mapper - transforms backend data to UI format
 */
