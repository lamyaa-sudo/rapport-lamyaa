...
Controller, Service, Repository et Entity.
...
\node[class, below=0pt of ch, align=left, text width=3.3cm, 
    ...
    {- feedbackService\\
     \hline\\
     + createFeedback()\\+ getAllFeedbacks()\\+ updateStatut()};
...
\node[class, below=0pt of sh, align=left, text width=3.3cm,
    ...
    {- feedbackRepo\\
     \hline\\
     + save(feedback)\\+ findAll()\\+ updateStatut()\\+ getStats()};
...
\node[class, below=0pt of fh, align=left, text width=3.3cm,
    ...
    {- id: Long\\- type: String\\- message: String\\
     - dateEnvoi: DateTime\\- statut: String\\- utilisateurId: Long\\
     \hline\\
     + getters()\\+ setters()};
...
organisé selon le pattern en couches de Spring Boot. Le FeedbackController 
reçoit les requêtes HTTP et délègue au FeedbackService qui implémente 
la logique métier. Le FeedbackService utilise le FeedbackRepository 
pour persister les données dans PostgreSQL via Spring Data JPA. La classe 
Feedback est l'entité centrale du modèle, liée à la classe Utilisateur.
